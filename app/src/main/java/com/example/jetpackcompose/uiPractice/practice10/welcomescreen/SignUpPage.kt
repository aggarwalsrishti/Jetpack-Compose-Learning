...
@Composable
fun SignUpButtonForForm(email:String, userName: String, password: String, navController: NavHostController){
    Button(
...
@Composable
fun BottomTextSignUp(navController: NavHostController) {
    Row(
        modifier = Modifier.fillMaxWidth(),
...
fun SignUpPage(navController: NavHostController
    ...
    Column(
        ...
        EmailFieldSignUp(email=email,
            onEmailChange ={email=it})
        Spacer(modifier = Modifier.height(20.dp))
        UsernameFieldSignUp(userName=userName,
            onUserNameChange ={userName=it})
        Spacer(modifier = Modifier.height(20.dp))
        PasswordFieldSignUp(password=password,
        ...
        BottomTextSignUp(navController)
